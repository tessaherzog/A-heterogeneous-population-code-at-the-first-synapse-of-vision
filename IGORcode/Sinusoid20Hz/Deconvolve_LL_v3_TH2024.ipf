...
// function from Leon 21/03/2022
// disabled baseline correction as not applicable to all analyses
// disabled display of deconvolved wave
// added line to rename "waveOUT" as "Trace_Decon"
// added line to kill unused waves
...
Function DeconvolveT2(waveIn,TauOn,TauOff) // use (recordingname, 0, 0.06)
wave waveIn
variable TauOn, TauOff
...
// TH disabled this section as don't want baseline correction on all analyses
...
//Duplicate/O/R=(0.9,1)(nContrasts-1,nContrasts-1), waveInCopy_smth, minIntWave  
...
// TH disbaled decon trace display
...
duplicate/o waveIn, Trace
duplicate/o waveOut, Trace_Decon

killwaves /z dcwave, result2, result, waveInCopy_smth, minIntWave

// TH added line to kill waves not used in further analysis
wave filtered,G,h,HF,HMAGSQR,kernel,kernel_smth,N,oneWave,oneWave_D,oneWave_H,oneWave_S,SF,SNR,waveInCopy,waveOut,wave_smth,W_coef,XCONVG,xfiltered,XSIG,xsignal
KillWaves  filtered,G,h,HF,HMAGSQR,kernel,kernel_smth,N,oneWave,oneWave_D,oneWave_H,oneWave_S,SF,SNR,waveInCopy,waveOut,wave_smth,W_coef,XCONVG,xfiltered,XSIG,xsignal
